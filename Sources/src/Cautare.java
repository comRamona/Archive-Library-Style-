...
public class Cautare extends JPanel {
	...
	public void addComponents() {
		...
		btnCautareNoua.setBounds(698, 140, 189, 43);
		...
		Font myFont2 = new Font("Serif", Font.PLAIN, 14);
		listres.setFont(myFont2);
		...
		btImpr = new JButton("Vezi imprumuturi");
		btImpr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				results();
			}
		});
		btImpr.setBounds(409, 342, 189, 43);
		btImpr.setEnabled(false);
		add(btImpr);
	...
	public void results() {
		// tabel istoric imprumut in fereastra noua
		InstantaDosar p = (InstantaDosar) listres.getSelectedValue();
		ist = datab.cautaImprumut(p);
		JFrame frame = new JFrame("Istoric imprumuturi");
